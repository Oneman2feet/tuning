...
// ------------- TRIADS ---------------------------
    ...
    "0,4,8": { "root": 0, "name": "Augmented", "notation": "X<sup>+</sup>", "tuning": "8:10:13"}, // perfect augmented
    "0,4,10": { "root": 0, "name": "Dominant Seventh (fifth omitted)", "notation": "X<sup>7no5</sup>", "tuning": "4:5:7"},
...
// -------------- TETRADS -------------------------
    ...
    "0,4,7,11": { "root": 0, "name": "Major Seventh", "notation": "X<sup>M7</sup>", "tuning": "8:10:12:15"},
    ...
    "0,3,6,9": { "root": 0, "name": "Diminished Seventh", "notation": "x<sup>\u006f7</sup>", "tuning": "15:18:21:25"},
    "0,3,7,11": { "root": 0, "name": "Minor-Major Seventh", "notation": "Xm<sup>+7</sup>"},
    "0,4,8,9": { "root": 3, "name": "Minor-Major Seventh (first inversion)", "notation": "Xm<sup>+7</sup>/Y"},
    "0,4,5,8": { "root": 2, "name": "Minor-Major Seventh (second inversion)", "notation": "Xm<sup>+7</sup>/Y"},
    "0,1,4,8": { "root": 1, "name": "Minor-Major Seventh (third inversion)", "notation": "Xm<sup>+7</sup>/Y"},
    "0,4,8,10": { "root": 0, "name": "Augmented-Minor Seventh", "notation": "X<sup>+7</sup>"},
    "0,4,6,8": { "root": 3, "name": "Augmented-Minor Seventh (first inversion)", "notation": "X<sup>+7</sup>/Y"},
    "0,2,4,8": { "root": 2, "name": "Augmented-Minor Seventh (second inversion)", "notation": "X<sup>+7</sup>/Y"},
    "0,2,6,10": { "root": 1, "name": "Augmented-Minor Seventh (third inversion)", "notation": "X<sup>+7</sup>/Y"},
    "0,4,8,11": { "root": 0, "name": "Augmented-Major Seventh", "notation": "X<sup>+M7</sup>"},
    "0,4,7,8": { "root": 3, "name": "Augmented-Major Seventh (first inversion)", "notation": "X<sup>+M7</sup>/Y"},
    "0,3,4,8": { "root": 2, "name": "Augmented-Major Seventh (second inversion)", "notation": "X<sup>+M7</sup>/Y"},
    "0,1,5,9": { "root": 1, "name": "Augmented-Major Seventh (third inversion)", "notation": "X<sup>+M7</sup>/Y"},
    "0,4,6,10": { "root": 0, "name": "Seventh flat five", "notation": "X<sup>7\u266d5</sup>", "tuning": "12:15:17:21"}, // 20:25:28:35 or 8:10:11:14 or 12:15:17:21
    "0,2,4,10": { "root": 0, "name": "Dominant Ninth (fifth omitted)", "notation": "X<sup>9</sup>", "tuning": "8:9:10:14"}
